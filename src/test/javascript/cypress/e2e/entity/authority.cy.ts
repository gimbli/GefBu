...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '9ddd72dd-7928-46fd-ba8f-541635d8374d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('dc24226f-fbdb-48c5-b591-37bde4f4db54');
      cy.get(`[data-cy="name"]`).should('have.value', 'dc24226f-fbdb-48c5-b591-37bde4f4db54');
